...
class PlaylistViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        APICaller.shared.getPlaylistDetailes(for: playlist ) { result in
    ...
    @objc func didLongPress(_ gesture:UILongPressGestureRecognizer){
        ...
        actionSheet.addAction(UIAlertAction(title: "Remove" , style: .destructive, handler: {[weak self] _ in
            ...
            APICaller.shared.removeTrackFromPlaylist(track: trackToDelete, playlist: strongSelf.playlist ) { seccess in
                DispatchQueue.main.async{
                    if seccess{
...
extension PlaylistViewController:UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        PlaybackPresenter.shared.tracks = tracks
        PlaybackPresenter.shared.startPlayback(from: self, track: track)
    }

}
extension PlaylistViewController: PlaylistHeaderUICollectionReusableViewDelegete{
